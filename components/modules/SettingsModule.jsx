...
export default function SettingsModule({ settings, setSettings, students, setStudents, finRecords, setFinRecords, webExams, setWebExams, centerExams, setCenterExams, examQs, setExamQs, cloudBackupState, backupToCloud, restoreFromCloud, onClose }) {
